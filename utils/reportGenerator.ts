...
<head>
    ...
    <style>
        ...
        * { -webkit-print-color-adjust: exact !important; print-color-adjust: exact !important; box-sizing: border-box; }
        ...
        .stat-val {
            font-size: 36px; font-weight: 900; color: #F8FAFC; display: block; margin-bottom: 5px;
        }

        .stat-label {
            font-size: 10px; font-weight: 700; color: #94A3B8; text-transform: uppercase; letter-spacing: 2px;
        }
        ...
        .legend { flex: 1; }
        .leg-item { display: flex; align-items: center; margin-bottom: 10px; font-size: 12px; font-weight: 600; }
        .leg-cap { width: 8px; height: 8px; border-radius: 2px; margin-right: 10px; }
        ...
        .b-mini {
            background: #161B33; border: 1px solid #2D3748; border-radius: 12px; padding: 12px; text-align: center;
        }
        .b-icon { font-size: 20px; margin-bottom: 4px; }
        .b-name { font-size: 9px; font-weight: 800; color: #CBD5E1; text-transform: uppercase; }

        .checklist-grid {
            display: grid;
            grid-template-columns: 1fr 1fr;
            gap: 20px;
            flex-grow: 1; /* Allow to fill remaining space but not overflow */
            overflow: hidden;
        }
        ...
        .box-title {
            font-size: 10px; font-weight: 800; color: #94A3B8; margin-bottom: 12px; text-transform: uppercase; letter-spacing: 1px;
            border-bottom: 1px solid #1E293B; padding-bottom: 8px;
        }

        .check-item {
            display: flex; align-items: center; gap: 8px; margin-bottom: 8px; font-size: 12px; color: #E2E8F0;
        }
        ...
        .mega-quote {
            ...
            max-width: 90%;
            text-transform: uppercase;
            margin-bottom: 100px; /* Space for branding at bottom */
        }
        ...
        <div class="container">
            <div class="header">
                <div>
                    ...
                    <div style="font-size: 10px; font-weight: 700; color: #94A3B8; letter-spacing: 3px; margin-top: 5px; text-transform: uppercase;">
                        Performance Report // ${period}
                    </div>
                </div>
                <div style="text-align: right">
                    <div style="font-size: 12px; font-weight: 900; color: #FFFFFF;">${new Date().toLocaleDateString('en-US', { month: 'long', day: 'numeric', year: 'numeric' })}</div>
                    <div style="font-size: 9px; font-weight: 800; color: #06B6D4; margin-top: 4px; letter-spacing: 1px;">REPORT ID: ${new Date().getTime().toString().slice(-6)}</div>
                </div>
            </div>
            ...
            <div class="visuals">
                <div class="chart-box">
                    ...
                    <div class="legend">
                        <div style="font-size: 10px; font-weight: 800; color: #94A3B8; margin-bottom: 10px; text-transform: uppercase; letter-spacing: 1px;">Resource Allocation</div>
                ...
                <div class="badges-box">
                    ...
                    <div class="badge-grid">
                        ...
                        `).join('')}
                        ${unlockedBadges.length === 0 ? '<div style="grid-column: span 2; padding: 20px; color: #475569; text-align: center; font-size: 9px;">No Achievements Yet</div>' : ''}
                    </div>
                </div>
            </div>
            ...
            <div class="checklist-grid">
                <div class="checklist-box">
                    ...
                    ${todos.length > 0 ? todos.slice(0, 8).map(t => `
    ...
    <div class="page">
        ...
        <div class="page-2-content">
            ...
            <div class="brand-bottom">
                ...
                <div style="color: #64748B; font-weight: 700; font-size: 14px; letter-spacing: 4px; margin-top: 10px;">OWN YOUR FUTURE</div>
            </div>
        </div>
    </div>
</body>
